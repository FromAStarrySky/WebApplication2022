...
namespace iSchoolWebApp.Models
{
    public class Employment
    {
        ...
        public class EmployRoot
        {
            ...
            public List<ProfessionalEmploymentInformation> EmploymentTableInfo { get; set; }
            public List<CoopInformation> CoopTableInfo { get; set; }
            public List<Content> contentInfo { get; set; }
        }
